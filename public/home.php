        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <?php if ($user && UserValidator::isRole($user["role"], Role::Admin)): ?>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <?php if ($user && UserValidator::isRole($user["role"], Role::Admin)): ?>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">147</td>
                                <?php endif; ?>
                                <th scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="shrink-0 flex items-center">
                                        <img id='preview_img' class="h-12 w-12 object-cover rounded-full mr-3"
                                            src="img/caja_organizadora.png" alt="Current product photo" />
                                        <?=?>
                                    </div>
                                </th>
                                <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <form action="delete.php" method="POST">
                                            <div class="flex items-center space-x-4">
                                                <input type="text" name="id" value="147" hidden />
                                                <a href="update.php?id=147" data-drawer-target="drawer-update-product"
