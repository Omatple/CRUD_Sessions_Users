...
if (!CookiesManager::existsRemember() && CookiesManager::getCookie("email")) {
...
if (isset($_POST["email"])) {
    ...
    if (!UserValidator::isValidLengthPassword($password)) $hasErrors = true;
    if ($hasErrors || !UserValidator::isValidCredentials($email, $password)) Navigation::refresh();
    if (isset($_POST["remember"])) {
        CookiesManager::create("email", $email);
        CookiesManager::create("password", $password);
    }
    $_SESSION["user"] = UserEntity::getUserByUniqueField("email", $email);
        ...
        <form action="<?= $_SERVER["PHP_SELF"] ?>" method="POST" novalidate>
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email"
                    ...
                    placeholder="Enter your email" value="<?= CookiesManager::getCookie("email") ?>" required>
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password" name="password"
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                    placeholder="Enter your password" value="<?= CookiesManager::getCookie("password") ?>" required>
            ...
            <div class="w-1/2 flex items-center mb-4">
                <input type="checkbox" name="remember" value="remember"
                    ...
                    <?= CookiesManager::getCookie("remember") ?>>
